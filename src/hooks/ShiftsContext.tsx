...
interface ShiftsContextValue {
  shifts: Shift[];
  isLoading: boolean;
  addShift: (formData: ShiftFormData) => Promise<Shift | null>;
  updateShift: (id: string, formData: Partial<ShiftFormData>) => Promise<Shift | null>;
  deleteShift: (id: string) => Promise<void>;
  getShiftsByDate: (date: string) => Shift[];
  getShiftsByWeek: (startDate: string, endDate: string) => Shift[];
  getShiftsByCaregiver: (caregiverName: string) => Shift[];
  getUniqueCaregivers: () => string[];
